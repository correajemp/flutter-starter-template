...
class AppSettingsStorage {
  AppSettingsStorage({required SharedPreferences sharedPreferences}) : _prefs = sharedPreferences;

  final SharedPreferences _prefs;

  static const String _themeModeKey = 'app_setting_theme_mode';
  static const String _localeKey = 'app_setting_locale';
  static const String _onboardingCompletedKey = 'app_setting_onboarding_completed';

  Future<void> setThemeMode(String themeMode) => _prefs.setString(_themeModeKey, themeMode);
