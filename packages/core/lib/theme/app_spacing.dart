...
class AppSpacing extends ThemeExtension<AppSpacing> {
  ...
  EdgeInsets get listItemPadding => EdgeInsets.symmetric(horizontal: lg, vertical: md);
  EdgeInsets get inlinePadding => EdgeInsets.symmetric(horizontal: md, vertical: sm);
